                    ...
                    <div class="right_side2">
                        ...
                        <!---=== top navigation right side ====---->        
                                    <div class="row right_row1">
                                        <div class="top_div">
                                            <div class="top_left">
                                                <p class="task_p">Task Name - Project Name</p>
                                            </div>
	...
	export default {
      data(){
        ...
        async created(){
            console.log("ok");
            let res1 = await
                this.callApi('get',`singleAssignTask/${this.$route.params.id}`)
            
            if(res1.status == 200){
                
                this.projects = res1.data.AssignTask
                // this.progress = res1.data.progress
                
                
                // for(let d of this.projects){
                //     this.progress = this.progress + d.estimated_time 
                // }
